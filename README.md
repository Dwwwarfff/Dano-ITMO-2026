...
![альтмеханизм](content/альтмех.jpg)
...
![Изменение чистой прибыли сравнение лояльных и нелояльных клиентов](content/Изменение чистой прибыли сравнение лояльных и нелояльных клиентов.png)

Критерий Левене p-value: 0.4470

t-критерий Уэлча p-value: < 0.0001

Cohen's d: -0.88

Разница лояльные − нелояльные: -103.35

Вывод: Различие статистически значимо на уровне 5%. Лояльные клиенты имеют меньшее изменение, чем нелояльные.

### Проверка других порогов 

![чето](content/Устойчивость%20cnfn%20,kf%20,kf.png)

### Проверка на устойчивость

![Проверка на устойчивость](content/Проверка%20на%20устойчивость.png)

### Интерпретация модели
**Гипотеза частично подтвердилась** 

Лояльные клиенты после снижения кэшбэка сохраняют спрос на категорию готовых продуктов, чем нелояльные. Но у обеих групп чистая прибыль выросла, нелояльных клиентов прирост оказался выше на 103 ₽ на клиента. Различие статистически значимо

**Модель не устойчива**

Эффект по GMV готовой еды устойчив в большинстве возрастных групп.
По чистой прибыли устойчивость ниже: в отдельных возрастных группах эффект слабее из-за более низкой покупательной способности.
...
![линрег](content/линрег.jpg)

![альтуст](content/альтуст.jpg)
### 

---

## Ограничения
- Отсутствуют данные о подписках (Premium, Private)
- Наценка распространяет ся не на все товары в корзине
- Различие в охвате данных между историческим периодом и экспериментом

## Перспективы 

- Расширить исследование на данные о подписках
- Провести исследования на всех магазинах “Города”
- Продлить сроки эксперимента 

## Policy implications
Создание комбо-наборов и скидки на них
выгода «здесь и сейчас»

Нелояльным сохранять кэшбэк в чувствительных категориях
