...
### 5. Сравниваем метрики относительно изменения кэшбэка
...
- У пользователей с понижением кэшбэка чистая прибыль остаётся положительной
- У пользователей с повышением кэшбэка банк может уходить в минус из-за роста выплат
- 
### 6. Считаем изменение среднего чека
